  ...
  (let ((results t))
    (flet ((check (test-name actual expected)
      ...
      (let* ((head     (gensym "N"))
             ...
             (*1stfvec* (make-array +fvec-size+ :element-type 'bit :initial-element 0))
             (*2ndfvec* (make-array +fvec-size+ :element-type 'bit :initial-element 0))
             (*3rdfvec* (make-array +fvec-size+ :element-type 'bit :initial-element 0))
             (*index-to-fvec-alist*
